...
public class BankSelectionPageWithAmount {
	...
	@FindBy (id="bank-list-item-aibgb-sandbox")
	private WebElement aib;
	

	// Initialization
	public BankSelectionPageWithAmount(WebDriver driver) 
	{
